...
public enum ErrorCode {
	...
	FAIL_ACCESS_TOKEN_EXPIRED("[❎ ERROR] 인증 토큰이 만료되었습니다."),
	FAIL_REFRESH_TOKEN_EXPIRED("[❎ ERROR] 인증 토큰이 만료되었습니다."),
	FAIL_INVALID_ACCESS_TOKEN("[❎ ERROR] 유효하지 않은 인증 토큰입니다."),
	FAIL_INVALID_REFRESH_TOKEN("[❎ ERROR] 유효하지 않은 인증 토큰입니다."),
