...
public class PaymentConstant {
	...
	public static final String SUCCESS_URL = "http://dartgallery.site/api/payment/success";
	public static final String CANCEL_URL = "http://dartgallery.site/api/payment/cancel";
	public static final String FAIL_URL = "http://dartgallery.site/api/payment/fail";
